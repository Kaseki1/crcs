        ...
        <div class="card-body">
          <form action="/" method="POST">
            <div class="form-group">
              ...
              <small id="emailHelp" class="form-text text-muted">Ваша почта понадобится для восстановления пароля.</small>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Пароль</label>
              <input type="password" class="form-control" id="exampleInputPassword1" aria-describedby="passwordHelp">
              <small id="passwordHelp" class="form-text text-muted">Пароль должен осдержать не менее 16 символов.</small>
            </div>
            <div class="form-group">
